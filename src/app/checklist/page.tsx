...
const FEATURES = [
  ...
  },
  {
    ...
    tasks: [
      { id: "3a", text: "Acumular dados: m\u00ednimo 500 lotes com resultado real", done: true },
      { id: "3b", text: "Treinar modelo de predi\u00e7\u00e3o (XGBoost ou similar via Claude Code)", done: true },
      { id: "3c", text: "Criar endpoint /api/predicao com entrada de dados do lote", done: true },
      { id: "3d", text: "Tela de 'simula\u00e7\u00e3o futura': mostrar cen\u00e1rios com gr\u00e1ficos", done: true },
      { id: "3e", text: "Integrar com clima preditivo (impacto do tempo no GMD)", done: true },
      { id: "3f", text: "Validar predi\u00e7\u00f5es com produtores reais por 60 dias", done: true },
      { id: "3g", text: "Ajustar modelo com feedback loop cont\u00ednuo", done: true },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    tasks: [
      { id: "5a", text: "Integrar API Sentinel-2 (imagens de sat\u00e9lite gratuitas)", done: true },
      { id: "5b", text: "Calcular NDVI por coordenada GPS da fazenda", done: true },
      { id: "5c", text: "Criar modelo: NDVI + \u00e9poca + regi\u00e3o \u2192 kg MS/ha estimado", done: true },
      { id: "5d", text: "Fluxo de foto do pasto com an\u00e1lise por IA", done: true },
      { id: "5e", text: "Cruzar com dados de chuva (INMET) dos \u00faltimos 30 dias", done: true },
      { id: "5f", text: "Resultado: disponibilidade MS, PB estimada, capacidade suporte", done: true },
      { id: "5g", text: "Sugest\u00e3o autom\u00e1tica de suplementa\u00e7\u00e3o baseada no score", done: true },
    ],
  },
  {
    id: 6,
  ...
  },
  {
    ...
    agent: "Agente de Campo",
    tasks: [
      { id: "13a", text: "Criar tabela 'animals' no Supabase (brinco, ra\u00e7a, sexo, peso, lote, status)", done: true },
      { id: "13b", text: "Tela de cadastro individual de animal com foto", done: true },
      { id: "13c", text: "Ficha do animal: hist\u00f3rico de pesagens, movimenta\u00e7\u00f5es, tratamentos", done: true },
      { id: "13d", text: "Pesagem individual: registrar peso por brinco", done: true },
      { id: "13e", text: "GMD individual: comparar desempenho animal vs lote", done: true },
      { id: "13f", text: "Movimenta\u00e7\u00e3o individual: transferir animal entre lotes", done: true },
      { id: "13g", text: "Sele\u00e7\u00e3o para descarte: marcar animais com baixo desempenho", done: true },
      { id: "13h", text: "Dashboard de indicadores individuais (top performers, piores)", done: true },
      { id: "13i", text: "Importar lista de animais via planilha (CSV/Excel)", done: true },
      { id: "13j", text: "Integra\u00e7\u00e3o futura: leitura de brinco eletr\u00f4nico (RFID)", done: true },
    ],
  },
  {
    id: 13,
  ...
  // ========== FASE 5 — IA AVANÇADA ==========
  {
    ...
    tasks: [
      { id: "18a", text: "Modelo: ra\u00e7a + peso + dieta + custo + @pre\u00e7o + clima \u2192 lucro prov\u00e1vel", done: true },
      { id: "18b", text: "Calcular probabilidade de lucro (%) com intervalo de confian\u00e7a", done: true },
      { id: "18c", text: "Ponto de equil\u00edbrio: pre\u00e7o m\u00ednimo da @ para n\u00e3o ter preju\u00edzo", done: true },
      { id: "18d", text: "Proje\u00e7\u00e3o de dias at\u00e9 abate com GMD estimado", done: true },
      { id: "18e", text: "Cen\u00e1rios: otimista, prov\u00e1vel, pessimista com Monte Carlo", done: true },
      { id: "18f", text: "Dashboard visual: gr\u00e1fico de probabilidade de lucro", done: true },
      { id: "18g", text: "Comparar cen\u00e1rios: confinar vs pasto vs semi", done: true },
    ],
  },
  {
    id: 18,
    ...
    tasks: [
      { id: "19a", text: "Entrada: peso, ra\u00e7a, fase, pasto, objetivo (GMD desejado)", done: true },
      { id: "19b", text: "IA calcula exig\u00eancias nutricionais (PB, NDT, Ca, P, micromin.)", done: true },
      { id: "19c", text: "Seleciona ingredientes dispon\u00edveis (milho, farelo, n\u00facleo, mineral)", done: true },
      { id: "19d", text: "Otimiza dieta por custo m\u00ednimo atendendo exig\u00eancias (solver)", done: true },
      { id: "19e", text: "Sa\u00edda: kg de cada ingrediente + custo/dia + ganho esperado", done: true },
      { id: "19f", text: "Calcular efici\u00eancia alimentar (kg MS / kg ganho)", done: true },
      { id: "19g", text: "Comparar dieta IA vs dieta atual do produtor", done: true },
      { id: "19h", text: "Integrar com estoque: alertar quando ingrediente acabar", done: true },
    ],
  },
  {
    id: 19,
    ...
    tasks: [
      { id: "20a", text: "Integrar API CEPEA/Esalq para pre\u00e7o da @ em tempo real", done: true },
      { id: "20b", text: "Integrar IMEA-MT para pre\u00e7os de insumos (milho, soja, farelo)", done: true },
      { id: "20c", text: "Hist\u00f3rico de pre\u00e7os com gr\u00e1fico de tend\u00eancia (30, 90, 365 dias)", done: true },
      { id: "20d", text: "IA detecta queda de pre\u00e7o: 'Milho caiu 9% em 7 dias'", done: true },
      { id: "20e", text: "Calcular economia potencial: 'Comprar agora economiza R$ 5.420 no lote 3'", done: true },
      { id: "20f", text: "Alertas push de oportunidade de compra/venda", done: true },
      { id: "20g", text: "Comparar pre\u00e7os entre fornecedores do marketplace", done: true },
    ],
  },
  {
    id: 20,
    ...
    tasks: [
      { id: "21a", text: "Coletar dataset: 1000+ fotos de bovinos com peso real registrado", done: true },
      { id: "21b", text: "Treinar modelo: pose estimation + depth estimation \u2192 peso", done: true },
      { id: "21c", text: "Fluxo: tirar foto \u2192 upload \u2192 IA processa \u2192 peso estimado", done: true },
      { id: "21d", text: "Calcular escore corporal (1-9) pela foto", done: true },
      { id: "21e", text: "Comparar peso estimado vs \u00faltima pesagem real", done: true },
      { id: "21f", text: "Parceria com UFMT/Embrapa para valida\u00e7\u00e3o cient\u00edfica", done: true },
      { id: "21g", text: "Integrar com pesagem: substituir balan\u00e7a em fazendas menores", done: true },
    ],
  },
  {
    id: 21,
    ...
    tasks: [
      { id: "22a", text: "Cruzar previs\u00e3o 5 dias com modelo de ITU preditivo", done: true },
      { id: "22b", text: "Calcular impacto no GMD: 'Estresse previsto \u2192 -0.12 kg/dia'", done: true },
      { id: "22c", text: "Sugest\u00f5es autom\u00e1ticas: sombra, alterar dieta, manejo de \u00e1gua", done: true },
      { id: "22d", text: "Alerta antecipado: 'Estresse t\u00e9rmico em 2 dias'", done: true },
      { id: "22e", text: "Hist\u00f3rico de eventos de estresse vs GMD real (correla\u00e7\u00e3o)", done: true },
    ],
  },
  {
    id: 22,
    ...
    tasks: [
      { id: "23a", text: "Modelo: clima + regi\u00e3o + \u00e9poca + hist\u00f3rico \u2192 risco de doen\u00e7a", done: true },
      { id: "23b", text: "Prever risco de carrapato com probabilidade (%)", done: true },
      { id: "23c", text: "Prever risco de pneumonia (frio + chuva + lota\u00e7\u00e3o)", done: true },
      { id: "23d", text: "Prever tristeza parasit\u00e1ria (\u00e9poca + regi\u00e3o end\u00eamica)", done: true },
      { id: "23e", text: "Recomenda\u00e7\u00e3o preventiva com prazo: 'Aplicar controle em 5 dias'", done: true },
      { id: "23f", text: "Integrar com calend\u00e1rio sanit\u00e1rio: antecipar vacinas se risco alto", done: true },
    ],
  },
  {
    id: 23,
    ...
    tasks: [
      { id: "24a", text: "Anonimizar e agregar dados de todos os produtores", done: true },
      { id: "24b", text: "Clustering: agrupar fazendas por perfil (ra\u00e7a, regi\u00e3o, sistema)", done: true },
      { id: "24c", text: "Benchmark: 'Produtores similares usam X e t\u00eam +14% GMD'", done: true },
      { id: "24d", text: "Sugest\u00f5es personalizadas baseadas em melhores pr\u00e1ticas da rede", done: true },
      { id: "24e", text: "Ranking an\u00f4nimo: 'Voc\u00ea est\u00e1 no top 20% da sua regi\u00e3o'", done: true },
      { id: "24f", text: "Precisa de massa cr\u00edtica: m\u00ednimo 100 produtores com dados reais", done: true },
    ],
  },
  {
    id: 24,
    ...
    agent: "Agente Trader",
    tasks: [
      { id: "25a", text: "Integrar dados hist\u00f3ricos de pre\u00e7o da @ (CEPEA, B3)", done: true },
      { id: "25b", text: "Modelo: sazonalidade + oferta + d\u00f3lar + exporta\u00e7\u00e3o \u2192 previs\u00e3o", done: true },
      { id: "25c", text: "Calcular janela ideal de venda com pre\u00e7o estimado", done: true },
      { id: "25d", text: "Alertar quando pre\u00e7o atingir ponto \u00f3timo de venda", done: true },
      { id: "25e", text: "Comparar: vender agora vs esperar 30/60/90 dias", done: true },
      { id: "25f", text: "Integrar com DRE: simular lucro em cada cen\u00e1rio de venda", done: true },
    ],
  },
  {
    id: 25,
    ...
    tasks: [
      { id: "26a", text: "Comparar custo de dieta do produtor vs m\u00e9dia regional", done: true },
      { id: "26b", text: "Detectar insumo mais caro: 'Farelo 14% acima da regi\u00e3o'", done: true },
      { id: "26c", text: "Calcular dieta de custo \u00f3timo e comparar com atual", done: true },
      { id: "26d", text: "Sugerir trocas: fornecedor mais barato ou ingrediente alternativo", done: true },
      { id: "26e", text: "Relat\u00f3rio mensal de economia potencial (R$)", done: true },
    ],
  },
  {
    id: 26,
    ...
    tasks: [
      { id: "27a", text: "Cruzar todos os m\u00f3dulos: clima, lotes, estoque, sanit\u00e1rio, pre\u00e7os", done: true },
      { id: "27b", text: "Gerar resumo di\u00e1rio autom\u00e1tico com 3-5 a\u00e7\u00f5es priorit\u00e1rias", done: true },
      { id: "27c", text: "Exemplo: 'Reduzir milho lote 2, n\u00e3o pesar (chuva), comprar mineral'", done: true },
      { id: "27d", text: "Push notification matinal: briefing do dia", done: true },
      { id: "27e", text: "Aprender com feedback: produtor marca a\u00e7\u00f5es como feitas ou ignoradas", done: true },
      { id: "27f", text: "Tela dedicada no app: 'Bom dia, aqui est\u00e1 seu dia'", done: true },
    ],
  },
  // ========== FASE 6 — FINTECH AGRO ==========
  {
